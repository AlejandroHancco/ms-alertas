...
ALTER TABLE comunicados ADD COLUMN IF NOT EXISTS archivado INTEGER DEFAULT 0;
ALTER TABLE inventarios DROP COLUMN IF EXISTS nota;
ALTER TABLE clientes ADD COLUMN IF NOT EXISTS archivado INTEGER DEFAULT 0;
"""
